    ...
    <ConversationProvider>
      <div className="flex h-screen w-screen overflow-hidden bg-[var(--chat-bg)]">
        ...
        <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
          {/* Mobile topbar */}
          <div className="md:hidden flex items-center gap-3 px-4 py-3 border-b border-[var(--border-color)] bg-[var(--chat-bg)] shrink-0">
            <button
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm font-semibold text-[var(--text-primary)]">ReseaKnowGPT</span>
            </div>
          </div>
